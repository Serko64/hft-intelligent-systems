...
# hidden layer widths; change to (256, 256) for harder circuits
NET_HIDDEN = (128, 128)
...
# gradient update every N steps (8 = ~50% less grad overhead vs 4)
TRAIN_FREQ = 8
...
# floor for greedy evaluation steps (honest fitness signal)
EVAL_STEPS = 2_000
